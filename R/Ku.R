...
#' @description Calculates unsaturated hydraulic conductivity for a given suction for unimodal or bimodal van Genuchten-Mualem (vg/vgm) or Peters-Durner-Iden (PDI) parameterisation.
